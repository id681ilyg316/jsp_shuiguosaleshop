        ...
        <nav class="navbar navbar-default" role="navigation">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle <c:if test="${param.flag==2}">active</c:if>" data-toggle="dropdown">水果分类<b class="caret"></b></a>
                    ...
                    <li><a href="/goodsrecommend_list?type=2" <c:if test="${param.flag==3 && t==2}">class="active"</c:if>>热门水果</a></li>
                    ...
                    <c:choose><c:when test="${empty user }">
                        ...
                        <li><a href="/user_login.jsp" <c:if test="${param.flag==9 }">class="active"</c:if>>用户登录</a></li>
                        <li><a href="/admin_login.jsp" <c:if test="${param.flag==11 }">class="active"</c:if>>管理员登录</a></li>
                    </c:when><c:otherwise>
