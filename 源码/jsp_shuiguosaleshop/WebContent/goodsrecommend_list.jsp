...
<div class="products">
    <div class="container">
        <h2><c:choose><c:when test="${t==2}">热门水果</c:when><c:otherwise>新品水果</c:otherwise></c:choose></h2>
                ...
                <div class="product-grid">
                    <a href="/goods_detail?id=${g.id}">
                        ...
                        <div class="product-img b-link-stripe b-animate-go  thickbox">
                            <img style="width:350px;height:200px" src="/${g.cover}" class="img-responsive" alt="${g.name}" width="240" height="240">
                            <div class="b-wrapper">
